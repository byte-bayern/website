module.exports = {
  siteMetadata: {
    ...
    metaKeywords: ['Bayerische Staatsregierung', 'Offiziell', 'Freistaat Bayern', 'Bayern', 'Freistaat', 'Bavaria', 'Free State of Bavaria', 'Politik', 'Politikthemen', 'aktuelle Meldungen', 'Meldungen', 'Staatsregierung']
  },
  plugins: [
    "gatsby-plugin-sass",
    ...
    "gatsby-plugin-sitemap",
    {
      ...
      options: {
        icon: "src/assets/img/components/brand/favicon.png",
      },
    },
    {
