          ...
          <div className={`col-12 lg:col-6 header- xs:p-grid-standard lg:pyr-grid-standard`}>
            <div className="grid xs:grid-gap-20 md:grid-gap-50 lg:grid-gap-100 justify-end height-100 align-center">
              <div className="col-12">
                <h1 className={`headline-1 pb-20`}>Wir sind byte.</h1>
                <h2 className={`pt-20 headline-2`}>Als Digitalisierungs­partner der bayerischen Ministerien und staatlichen Behörden unterstützen und beraten wir die staatliche Verwaltung bei der Entwicklung und Umsetzung digitaler Produkte und Services.</h2>
              </div>
            </div>
          </div>
